...
BLECharacteristic HIDCharacteristicTX(BLEUUID((uint16_t)0x2A3D), BLECharacteristic::PROPERTY_READ | BLECharacteristic::PROPERTY_NOTIFY);
...
void loop() {
  // HIDCharacteristic.setValue(level, 1);
  // HIDCharacteristic.setValue(value.c_str());
